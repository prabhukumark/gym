    ...
    <script>
        async function submitForm() {
            ...
            try {
                ...
                document.getElementById('signupStatus').innerHTML = '<p>Sign up successful! Welcome, ' + userName + '!</p>';
            } catch (error) {
                console.error("Error sending email:", error);
                // Display error message if email sending fails
                document.getElementById('signupStatus').innerHTML = '<p>Error sending email. Please try again later.</p>';
            }
        }
